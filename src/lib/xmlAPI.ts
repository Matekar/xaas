export interface XML {
	...
	document: undefined | XMLDocument;
}
...
export module XML {
	 ...
	 */
	export const serialize = (xmlp: XML, root: Node = <Node>xmlp.document) => {
	 ...
	 * @returns found Node
	 */
	export const findNodeByPath = (document: XMLDocument, path: string) => {
	 ...
	 */
	export const findNodesByPath = (document: XMLDocument, path: string) => {
	...
	export const findNodesByAttribute = (
		...
		return Array.from(root.querySelectorAll(`${node}[${attribute}='${value}']`));
	};
	...
	export const createNode = (xdoc: XMLDocument, parent: Node, name: string) => {
		...
		return parent.appendChild(xdoc.createElement(name));
	};
	 ...
	 */
	export const modifyNodeAttribute = (node: Element, attribute: string, newValue: string) => {
	 ...
	 * @param newValue new value to be set
	 */
	export const modifyNodesAttribute = (nodes: Element[], attribute: string, newValue: string) => {
		for (let node of nodes) {
